...
$payment['bill']['name'] = '快钱支付';    //插件的代码必须和文件名保持一致
...
class bill
{
    ...
    function pay_send($sn,$amount)    //提交支付请求
	{
	    ...
	    $merchant_url = "$main_settings[mm_mall_url]/respond.php?sessionID=$sessionID&code=".basename(__FILE__, '.class.php');    //支付结果返回地址
