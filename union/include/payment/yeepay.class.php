...
class yeepay
{
    ...
    function pay_send($sn,$amount)    //提交支付请求，sn订单号，$amount支付价格
	{
	    ...
	    $p8_Url = "$main_settings[mm_mall_url]/respond.php?sessionID=$sessionID&code=".basename(__FILE__, '.class.php');
    ...
    function pay_receive()    //提交返回处理
    {
	    ...
	    if (strtoupper($svrHmac)==strtoupper($sNewString) && $succeed == '1')
	    {
