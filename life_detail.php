 ...
 * $Date: 2008-06-28 $
 * $Id: life_detail.php  www.mvmmall.cn$
 * ---------------------------------------------
*/
...
if(!$comm['c_logo']) $comm['c_logo']='images/noimages/noproduct.jpg';
else $comm['c_logo']=IMG_URL.$comm['c_logo'];
...
$q=$db->query("SELECT uid,t_name,m_uid,register_date,content,cover,tags 
               ...
               WHERE c_uid='$comm[uid]' AND approval_date>10 
               $order_sql 
               LIMIT 8");
while ($rtl=$db->fetch_array($q))
{
