...
class alipay_transfer_service {
	...
	*$sign_type 签名类型
    */
    function alipay_transfer_service($parameter,$key,$sign_type) {
	...
	*return 表单提交HTML文本
    ...
    function build_form() {
		//GET方式传递
        $sHtml = "<form id='alipaysubmit' name='alipaysubmit' target='_blank' action='".$this->gateway."_input_charset=".$this->parameter['_input_charset']."' method='get'>";
