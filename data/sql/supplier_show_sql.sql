...
('mm_dist_range', '全国', SUPPLIER_ID),
('mm_dist_instr', '默认普通物流，特殊需要可发快递', SUPPLIER_ID),
('mm_client_time', '7*24小时', SUPPLIER_ID),
('mm_client_qq2', '58701995', SUPPLIER_ID),
('mm_client_qq1', '61239508', SUPPLIER_ID),
('mm_client_fax', '0596-2968077', SUPPLIER_ID),
('mm_client_ww', 'admin@mvmmall.com', SUPPLIER_ID),
('mm_client_email', 'admin@mvmmall.com', SUPPLIER_ID),
...
(NULL, '商铺公告', '', '|||', 'board.php?action=notice', '商铺公告', 'head', 0, 2, 0, SUPPLIER_ID),
(NULL, '商铺介绍', '', '|||', 'page.php?action=shopdesc', '商铺介绍', 'head', 0, 3, 0, SUPPLIER_ID),
(NULL, '供应商品', '', '|||', 'goods.php?action=new', '供应商品', 'head', 0, 4, 0, SUPPLIER_ID),
(NULL, '公司招聘', '', '|||', 'page.php?action=employ', '公司招聘', 'head', 0, 5, 0, SUPPLIER_ID),
(NULL, '联系我们', '', '|||', 'page.php?action=contact', '联系我们', 'head', 0, 6, 0, SUPPLIER_ID),
(NULL, '资质证书', '', '|||', 'certi.php', '资质证书', 'head', 0, 7, 0, SUPPLIER_ID);
...
(NULL, 'contact', 'mvmmall多用户商城系统 多用户商城 多用户网店 同城购 社区商城', 'mvmmall多用户商城系统 多用户商城 多用户网店 同城购 社区商城', '联系我们', '<p>\r\n	联系我们\r\n</p>', 1387767651, SUPPLIER_ID),
(NULL, 'employ', 'mvmmall多用户商城系统 多用户商城 多用户网店 同城购 社区商城', 'mvmmall多用户商城系统 多用户商城 多用户网店 同城购 社区商城', '公司招聘', '<p>\r\n	公司招聘\r\n</p>', 1387767651, SUPPLIER_ID);
